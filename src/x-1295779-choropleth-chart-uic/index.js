...
const getContainer = (host) =>
	host && host.shadowRoot
		? host.shadowRoot.querySelector(".cc-root") ||
...
createCustomElement("x-2114311-choropleth-chart-uic", {
	...
	properties: {
		...
		colorMode: { default: "scheme" },
		colorScheme: { default: "blues" },
		valueColorScheme: { default: "" },
		customColorStart: { default: "#eff6ff" },
		customColorEnd: { default: "#1e3a8a" },
